...
import { FaHome, FaShoppingCart, FaWallet, FaFileAlt, FaFolderOpen, FaTasks, FaMoon } from "react-icons/fa";

const FixedSidebar = () => {
  return (
    <Box position="fixed" left="0" top="0" h="100vh" w="50px" bg="gray.800">
      <VStack spacing="32px" align="center" justify="space-between" h="100%">
        ...
        <IconButton icon={<FaMoon />} aria-label="Toggle Dark Mode" variant="ghost" color="white" />
      </VStack>
    </Box>
  );
};
